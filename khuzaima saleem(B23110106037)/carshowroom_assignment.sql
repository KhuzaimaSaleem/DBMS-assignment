-- CarShowroomDB Assignment #2 Solution
...
('Mike Davis', 'Chicago', 'IL', '2023-03-10'),
('Emily Brown', 'Houston', 'TX', '2023-04-05'),
('David Wilson', 'Phoenix', 'AZ', '2023-05-12'),
('Lisa Garcia', 'Philadelphia', 'PA', '2023-06-18'),
('Robert Miller', 'San Antonio', 'TX', '2023-07-22'),
('Jennifer Lee', 'San Diego', 'CA', '2023-08-30'),
('Michael Taylor', 'Dallas', 'TX', '2023-09-14'),
('Ashley Anderson', 'San Jose', 'CA', '2023-10-25'),
('Christopher Thomas', 'Austin', 'TX', '2023-11-08'),
('Amanda Jackson', 'Jacksonville', 'FL', '2023-12-03'),
('Matthew White', 'Indianapolis', 'IN', '2024-01-17'),
('Stephanie Harris', 'Columbus', 'OH', '2024-02-21'),
('Kevin Martin', 'Fort Worth', 'TX', '2024-03-15');

-- Insert Cars (ensuring brands have varying model counts for HAVING clause requirements)
INSERT INTO Cars (Model, Brand, Year, Price, Color, InventoryCount) VALUES
-- Toyota (7 models - more than 5)
...
-- February 2024 (22 sales - more than 20)
...
-- March 2024 (15 sales - less than 20)
...
-- April 2024 (21 sales - more than 20)
...
-- Insert Service Records (ensuring average costs vary by service type)
INSERT INTO ServiceRecords (CarID, ServiceDate, ServiceType, Cost, TechnicianID) VALUES
-- Oil Change (average around 80 - less than 500)
...
-- Brake Service (average around 350 - less than 500)
...
-- Transmission Repair (average around 800 - more than 500)
